    ...
    <div class="authentication-inner py-6">
      ...
      <div class="card p-md-7 p-1">
        ...
        <div class="card-body mt-1">
          ...
          <form id="formAuthentication" class="mb-5" action="{{ route('login') }}" method="GET">
          @csrf
            <div class="form-floating form-floating-outline mb-5">
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email-username" placeholder="Enter your email or username" autofocus>
